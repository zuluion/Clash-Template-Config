...
if($dir_isExist){
    ...
    # powershell iwr -Uri "https://cdn.jsdelivr.net/gh/zuluion/Clash-Template-Config@master/Ini-Files/provider-add-on.yml" -OutFile ".\myprovider\proxies\provider-add-on.yml"
